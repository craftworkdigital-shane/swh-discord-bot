    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName('help')
                .setDescription(
                    'Get information about the message category commands'
                )
        )
        .addSubcommandGroup((group) =>
            group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('wasted')
                        .setDescription('GTA wasted overlay')
                )
        )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the avatar from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the banner from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want to sleep with'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the blurred image from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the burned image from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want make a clown'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the colorified image from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the darkness image from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the facepalm image from'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want to make more gray'
                                )
                                .setRequired(true)
                        )
                )
                    ...
                    subcommand
                        ...
                        .addUserOption((option) =>
                            option
                                .setName('user')
                                .setDescription(
                                    'The user you want the inverted image from'
                                )
                                .setRequired(true)
                        )
                )
            ...
            group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('glass')
                        .setDescription(
                            'Overlays a glass texture over an image'
                        )
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        ...
                        .addChannelOption((option) =>
                            option
                                .setName('channel')
                                .setDescription(
                                    'Channel where the embed should be'
                                )
                                .setRequired(true)
